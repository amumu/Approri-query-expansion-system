...
class pygoogle:
	...
	def __init__(self,query,pages=10,hl='zh-TW'):
		...
		self.containerForFailedData = []    # this is used to collect JSON data	
		self.found = True
	...
	def __search__(self,print_results = False):
		...
		for page in range(0,self.pages):
			...
			if data['responseStatus'] != 200:
				self.collectFailureDatas(self.query)
				self.found = False
			else:
	...
	def collectFailureDatas(self, failedquery):
		self.containerForFailedData.append(failedquery)
